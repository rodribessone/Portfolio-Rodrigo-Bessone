export const translations = {
  es: {
    ...
    inicio: {
      ...
      descripcion: "Amante de la programación y el desarrollo web.",
    },
    proyectos: {
      titulo: "Proyectos destacados",
      descripcion: "Mi enfoque de diseño prioriza las necesidades y preferencias de los usuarios. Me concentro en crear productos que mejoren la experiencia del usuario, asegurándome de que sean funcionales y agradables de usar.",
  ...
  en: {
    ...
    inicio: {
      ...
      descripcion: "Passionate about programming and web development.",
    },
    proyectos: {
      titulo: "Featured Projects",
      descripcion: "My design approach prioritizes user needs and preferences. I focus on creating products that enhance the user experience, ensuring they are functional and enjoyable to use.",
